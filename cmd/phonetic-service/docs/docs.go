...
// SwaggerInfophonetic holds exported Swagger Info so clients can modify it
var SwaggerInfophonetic = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:8005",
	BasePath:         "/api/v1",
	Schemes:          []string{},
	...
	InfoInstanceName: "phonetic",
	SwaggerTemplate:  docTemplatephonetic,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfophonetic.InstanceName(), SwaggerInfophonetic)
}
