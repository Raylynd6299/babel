...
// SwaggerInfovocabulary holds exported Swagger Info so clients can modify it
var SwaggerInfovocabulary = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:8004",
	BasePath:         "/api/v1",
	Schemes:          []string{},
	...
	InfoInstanceName: "vocabulary",
	SwaggerTemplate:  docTemplatevocabulary,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfovocabulary.InstanceName(), SwaggerInfovocabulary)
}
